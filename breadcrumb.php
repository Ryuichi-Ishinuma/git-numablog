<?php
  ...
  //パンくずリスト用変数
  $out = $get_link_html(home_url(), "numablog").$del_str;
  ...
  if(is_home()) {
    ...
    $out .= $get_link_html(get_post_type_archive_link($posttype), post_type_archive_title('None', false)).$del_str;
  } elseif(is_archive()) {
    $out.= "アーカイブ";
  } elseif(is_search()) {
    $out.="検索結果";
